...
//   SVN Id            :  $Id: my_driver.h 484 2014-07-14 15:52:39Z barnasconi $
//
//----------------------------------------------------------------------
...
class my_driver : public uvm::uvm_driver<REQ,RSP>
{
 public:
  ...
  void run_phase(uvm::uvm_phase& phase)
  {
    ...
    for(;;) // forever loop
    {
      // try next item will return false if there is no item
      // available
      item_valid = this->seq_item_port->try_next_item(req);
