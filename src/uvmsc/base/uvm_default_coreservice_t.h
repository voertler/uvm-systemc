...
//  virtual void set_default_tr_database( uvm_tr_database* db );
  ...
  int& get_uvm_event_g_cnt() override;
  unsigned int& get_uvm_resource_base_default_precedence() override;
  bool& get_uvm_default_factory_m_debug_pass() override;
  int& get_uvm_recorder_handle() override;
  uvm_coreservice_t::recorder_handle_map_t& get_uvm_recorder_m_handles() override;
  int& get_uvm_sequencer_base_g_sequencer_id() override;
  int& get_uvm_sequencer_base_g_sequence_id() override;
  int& get_uvm_sequencer_base_g_request_id() override;
  unsigned int& get_uvm_reg_m_max_size() override;
  unsigned int& get_uvm_mem_m_max_size() override;
  bool& get_uvm_reg_field_m_predefined() override;
  unsigned int& get_uvm_reg_field_m_max_size() override;
  uvm_coreservice_t::reg_field_policy_map_t& get_uvm_reg_field_m_policy_names() override;
  int& get_uvm_reg_block_id() override;
  uvm_coreservice_t::reg_block_roots_map_t& get_uvm_reg_block_m_roots() override;
  uvm_coreservice_t::typeid_map_t& get_uvm_typeid_base_typeid_map() override;
  uvm_coreservice_t::type_map_t& get_uvm_typeid_base_type_map() override;
  uvm_reg_read_only_cbs* get_uvm_reg_read_only_cbs_m_me()  override;
  uvm_reg_write_only_cbs* get_uvm_reg_write_only_cbs_m_me()  override;
  ...
  bool& get_uvm_component_global_timeout_spawned_() override;
  bool& get_uvm_component__print_config_matches() override;
  bool& get_uvm_resource_options_auditing() override;
  bool& get_uvm_resource_db_options_ready() override;
  bool& get_uvm_resource_db_options_tracing() override;
  bool& get_uvm_config_db_options_ready() override;
  bool& get_uvm_config_db_options_tracing() override;
  bool& get_uvm_root_m_uvm_header_done() override;
  bool& get_uvm_report_catcher_in_catcher() override;
  bool& get_uvm_callbacks_base_m_tracing() override;
  uvm_reg_map* get_uvm_reg_map_m_backdoor() override;
  uvm_phase* get_uvm_domain_m_uvm_schedule() override;
  uvm_domain* get_uvm_domain_m_common_domain() override;
  void set_uvm_domain_m_common_domain( uvm_domain* domain ) override;
  uvm_domain* get_uvm_domain_m_uvm_domain() override;
  void set_uvm_domain_m_uvm_domain( uvm_domain* domain ) override;
  uvm_build_phase* get_uvm_build_phase_m_inst() override;
  uvm_connect_phase* get_uvm_connect_phase_m_inst() override;
  uvm_end_of_elaboration_phase* get_uvm_end_of_elaboration_phase_m_inst() override;
  uvm_start_of_simulation_phase* get_uvm_start_of_simulation_phase_m_inst() override;
  uvm_run_phase* get_uvm_run_phase_m_inst() override;
  uvm_extract_phase* get_uvm_extract_phase_m_inst() override;
  uvm_check_phase* get_uvm_check_phase_m_inst() override;
  uvm_report_phase* get_uvm_report_phase_m_inst() override;
  uvm_final_phase* get_uvm_final_phase_m_inst() override;
  uvm_pre_reset_phase* get_uvm_pre_reset_phase_m_inst() override;
  uvm_reset_phase* get_uvm_reset_phase_m_inst() override;
  uvm_post_reset_phase* get_uvm_post_reset_phase_m_inst() override;
  uvm_pre_configure_phase* get_uvm_pre_configure_phase_m_inst() override;
  uvm_configure_phase* get_uvm_configure_phase_m_inst() override;
  uvm_post_configure_phase* get_uvm_post_configure_phase_m_inst() override;
  uvm_pre_main_phase* get_uvm_pre_main_phase_m_inst() override;
  uvm_main_phase* get_uvm_main_phase_m_inst() override;
  uvm_post_main_phase* get_uvm_post_main_phase_m_inst() override;
  uvm_pre_shutdown_phase* get_uvm_pre_shutdown_phase_m_inst() override;
  uvm_shutdown_phase* get_uvm_shutdown_phase_m_inst() override;
  uvm_post_shutdown_phase* get_uvm_post_shutdown_phase_m_inst() override;

  uvm_root* get_root() override;
  uvm_report_message* get_uvm_report_message_l_report_message( const std::string& name ) override;
  uvm_report_cb_iter* get_uvm_report_catcher_name_iter() override;
  uvm_report_cb_iter* get_uvm_report_catcher_print_iter() override;
  uvm_coreservice_t::callback_pool_map_t& get_uvm_callbacks_base_m_pool() override;
  uvm_callbacks_base* get_uvm_callbacks_base_m_b_inst() override;
  uvm_coreservice_t::domain_map_t& get_uvm_domain_domains() override;
  uvm_coreservice_t::objection_list_t& get_uvm_objection_objections() override;
  uvm_coreservice_t::objection_context_list_t& get_uvm_objection_scheduled_list() override;
  sc_core::sc_event& get_uvm_objection_scheduled_list_changed() override;
  uvm_coreservice_t::phase_execution_map_t& get_uvm_phase_executing_phases() override;
  uvm_coreservice_t::phase_node_map_t& get_uvm_phase_phase_nodes() override;
  uvm_coreservice_t::typed_store_map_t& get_typed_store() override;
...
//  mutable uvm_tr_database* tr_database;
  ...
  uvm_coreservice_t::recorder_handle_map_t recorder_handles;
  ...
  uvm_coreservice_t::reg_field_policy_map_t reg_field_policy_names;
  ...
  std::unique_ptr<uvm_coreservice_t::callback_pool_map_t> callback_pool;
  ...
  uvm_coreservice_t::domain_map_t domains;
  uvm_coreservice_t::objection_list_t objections;
  uvm_coreservice_t::objection_context_list_t scheduled_objection_contexts;
  sc_core::sc_event scheduled_objection_list_changed;
  uvm_coreservice_t::phase_execution_map_t executing_phases;
  uvm_coreservice_t::phase_node_map_t phase_nodes;
  uvm_coreservice_t::regex_buffer_t regex_buffer;
  uvm_coreservice_t::typed_store_map_t typed_store;
