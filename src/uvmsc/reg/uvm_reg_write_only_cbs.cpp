...
uvm_reg_write_only_cbs::uvm_reg_write_only_cbs( const std::string& name ) : uvm_reg_cbs(name)
{}
...
void uvm_reg_write_only_cbs::add( uvm_reg* rg )
{
...
void uvm_reg_write_only_cbs::remove( uvm_reg* rg )
{
