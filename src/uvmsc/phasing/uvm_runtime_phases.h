...
//   SVN Id            :  $Id: uvm_runtime_phases.h 484 2014-07-14 15:52:39Z barnasconi $
//
//----------------------------------------------------------------------

#ifndef UVM_RUNTIME_PHASES_H_
#define UVM_RUNTIME_PHASES_H_
...
//! By default, all objects of type #uvm_component using the run-time schedule
...
//!
//! #uvm_process_phase that calls the
...
//! - Reset signal, if not driven by the verification environment,
//!   is asserted.
//----------------------------------------------------------------------
...
class uvm_pre_reset_phase : public uvm_process_phase
{
 ...
 protected:
  uvm_pre_reset_phase();
  explicit uvm_pre_reset_phase( const std::string& name );
};
...
class uvm_reset_phase : public uvm_process_phase
{
 ...
 protected:
  uvm_reset_phase();
  explicit uvm_reset_phase( const std::string& name );
};
...
class uvm_post_reset_phase : public uvm_process_phase
{
 ...
 protected:
  ...
  explicit uvm_post_reset_phase( const std::string& name );
};
...
class uvm_pre_configure_phase : public uvm_process_phase
{
 ...
 protected:
  uvm_pre_configure_phase();
   explicit uvm_pre_configure_phase( const std::string& name );
};
...
class uvm_configure_phase : public uvm_process_phase
{
 ...
 protected:
  uvm_configure_phase();
  explicit uvm_configure_phase( const std::string& name );
};
...
class uvm_post_configure_phase : public uvm_process_phase
{
 ...
 protected:
  ...
  explicit uvm_post_configure_phase( const std::string& name );
};
...
class uvm_pre_main_phase : public uvm_process_phase
{
 ...
 protected:
  uvm_pre_main_phase();
  explicit uvm_pre_main_phase( const std::string& name );
};
...
class uvm_main_phase : public uvm_process_phase
{
 ...
 protected:
  uvm_main_phase();
  explicit uvm_main_phase( const std::string& name );
};
...
class uvm_post_main_phase : public uvm_process_phase
{
 ...
 protected:
  uvm_post_main_phase();
  explicit uvm_post_main_phase( const std::string& name );
...
class uvm_pre_shutdown_phase : public uvm_process_phase
{
 ...
 protected:
  ...
  explicit uvm_pre_shutdown_phase( const std::string& name );
};
...
class uvm_shutdown_phase : public uvm_process_phase
{
 ...
 protected:
  uvm_shutdown_phase();
  explicit uvm_shutdown_phase( const std::string& name );
...
class uvm_post_shutdown_phase : public uvm_process_phase
{
 ...
 protected:
  ...
  explicit uvm_post_shutdown_phase( const std::string& name );

};

} // namespace uvm

#endif /* UVM_RUNTIME_PHASES_H_ */
