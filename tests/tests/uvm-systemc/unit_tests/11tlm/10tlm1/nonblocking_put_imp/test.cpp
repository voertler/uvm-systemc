...
{
 public:
  uvm::uvm_nonblocking_put_port<int> nb_put_port;
...
{
 public:
  uvm::uvm_nonblocking_put_imp<int,consumer> nb_put_imp;

  UVM_COMPONENT_UTILS(consumer);
  
  consumer( uvm::uvm_component_name name )
  : uvm::uvm_component(name),
    nb_put_imp("nb_put_imp", this) // bind imp to consumer
  {}

  bool try_put( const int& tr )
  {
    std::ostringstream msg;
    msg << "receiving " << tr;
